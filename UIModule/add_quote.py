...
class Add_Quote(Admin_Page):
    ...
    def _init_locators_add_quote(self):
        ...
        self.quote_success_created_loc = self.page.locator('xpath=/html/body/div[3]/div[2]/div[1]/div/form/div/h1[1]/'
                                                           'span/b')
        self.success_btn_loc = self.page.locator(B'xpath=/html/body/div[86]/div/div[6]/button[1]')
    ...
    def check_default_user(self):
        ...
        default_user_value = self.user_quote_select.evaluate("select => select.options[select.selectedIndex]."
                                                             "textContent").strip()
    ...
    def check_supplytype_value(self):
        ...
        supplytype_value = self.supply_type_select.text_content()  #取dropdown list的里面的各项
    ...
    def check_add_quote_success(self):
        ...
        self.page.evaluate("window.scrollTo(0, 0)")  # 滚动条拉到最上面
